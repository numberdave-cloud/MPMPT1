# Audio Player [Quest Begins / Main Theme from Bubble Bobble]

Directory: `audio-player-bubble-bobble/`
...
## Live URL
https://numberdave-cloud.github.io/MPMPT1/audio-player-bubble-bobble/
...
```html
<iframe
  src="https://numberdave-cloud.github.io/MPMPT1/audio-player-bubble-bobble/"
  width="100%"
  height="190"
  title="Quest Begins / Main Theme from Bubble Bobble audio player"
  style="border: none;"
  allow="autoplay"
  loading="lazy"></iframe>
```
...
## What it plays
Tadashi Kimijima, Quest Begins / Main Theme, from Bubble Bobble (1986).
YouTube ID `KOuVKxzW4Do`.

## Intake values
- Start: from the top, no fade-in
- End point: fade-out starts at 0:52, 10s fade-out

## Fade shape (resolved constants)
- Playback starts cold at 0:00 and holds at full to 0:52.
- `FADE_START` 52 (0:52): linear fade to silence begins.
- `FADE_DURATION` 10: silent at 1:02 (`SCALE` = 62), then pauses and offers
  replay (`STOP_AFTER_FADE` true).
- Progress bar and readout run 0:00 to 1:02 and fill to 100% at the moment it
  goes silent.
