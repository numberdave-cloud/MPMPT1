...
## Last updated
2026-08-12 (later still) - Swapped the scene video to A_L75X96Wns, in-point 0:48, out-point 2:07 (127s); crop and all behaviour unchanged. Earlier same day: LOAD starts scene and music together; stopped scene autoplay on page load; cropped YouTube chrome (2.15 / 1.18); fixed the false error 150 with an 1800 ms grace window; plus origin playerVar, no-end-screen, muted scene, code-specific errors, initial ship.
